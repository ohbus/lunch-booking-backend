...
class JwtHelperTest {
    ...
    void testGenerateJwtToken() {
        ...
        //   java.security.InvalidKeyException: java.security.ProviderException: Unsupported algorithm Algorithm
    ...
    void testValidateToken() {
        ...
        //   Reason: R013 No inputs found that don't throw a trivial exception.
        //   test threw
        //   java.lang.NullPointerException: Cannot invoke "com.auth0.jwt.interfaces.DecodedJWT.getExpiresAt()" because the return value of "xyz.subho.lunchbooking.security.JwtHelper.verifyAndDecodeJwt(String)" is null
    ...
    void testGetAuthenticatedUserDetails() {
        ...
        //   Reason: R013 No inputs found that don't throw a trivial exception.
        //   test threw
        //   java.lang.NullPointerException: Cannot invoke "com.auth0.jwt.interfaces.DecodedJWT.getClaims()" because the return value of "xyz.subho.lunchbooking.security.JwtHelper.verifyAndDecodeJwt(String)" is null
        //       at xyz.subho.lunchbooking.security.JwtHelper.extractAllClaims(JwtHelper.java:136)
        //       at xyz.subho.lunchbooking.security.JwtHelper.getAuthenticatedUserDetails(JwtHelper.java:107)
    ...
    void testExtractUsername() {
        ...
        //   Reason: R013 No inputs found that don't throw a trivial exception.
        //   test threw
        //   java.lang.NullPointerException: Cannot invoke "com.auth0.jwt.interfaces.DecodedJWT.getSubject()" because the return value of "xyz.subho.lunchbooking.security.JwtHelper.verifyAndDecodeJwt(String)" is null
