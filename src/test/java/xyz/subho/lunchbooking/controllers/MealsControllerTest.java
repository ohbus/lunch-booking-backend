...
class MealsControllerTest {
    ...
    void testActivateMeal() throws Exception {
        ...
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.put("/meal/activate/{mealId}", 123L);
        ResultActions actualPerformResult = MockMvcBuilders.standaloneSetup(mealsController)
                .build()
    ...
    void testLockMeal() throws Exception {
        ...
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.put("/meal/lock/{mealId}", 123L);
    ...
    void testGetAllMeals() throws Exception {
        ...
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/meal/{today}", true);
        MockMvcBuilders.standaloneSetup(mealsController)
                .build()
                .perform(requestBuilder)
                .andExpect(MockMvcResultMatchers.status().isOk())
    ...
    void testAddMeal() throws Exception {
        ...
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.post("/meal/create")
    ...
    void testDeActivateMeal() throws Exception {
        ...
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.delete("/meal/activate/{mealId}", 123L);
        MockMvcBuilders.standaloneSetup(mealsController)
                .build()
                .perform(requestBuilder)
                .andExpect(MockMvcResultMatchers.status().isOk())
    ...
    void testGetAllAvailableMeals3() throws Exception {
        when(mealsService.getMealCountByMealId(anyLong())).thenReturn(new MealAvailableCountModel(new HashMap<>()));
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/meal/count/{mealId}", 123L);
        MockMvcBuilders.standaloneSetup(mealsController)
                .build()
                .perform(requestBuilder)
                .andExpect(MockMvcResultMatchers.status().isOk())
    ...
    void testReadyMeal() throws Exception {
        ...
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.put("/meal/ready/{mealId}", 123L);
        MockMvcBuilders.standaloneSetup(mealsController)
                .build()
                .perform(requestBuilder)
                .andExpect(MockMvcResultMatchers.status().isOk())
    ...
    void testUnLockMeal() throws Exception {
        ...
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.delete("/meal/lock/{mealId}", 123L);
        MockMvcBuilders.standaloneSetup(mealsController)
                .build()
                .perform(requestBuilder)
                .andExpect(MockMvcResultMatchers.status().isOk())
    ...
    void testUnReadyMeal() throws Exception {
        ...
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.delete("/meal/ready/{mealId}", 123L);
        MockMvcBuilders.standaloneSetup(mealsController)
                .build()
                .perform(requestBuilder)
                .andExpect(MockMvcResultMatchers.status().isOk())
