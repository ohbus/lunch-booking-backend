...
class LoginControllerTest {
    ...
    void testCheckPhoneExist() throws Exception {
        ...
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.post("/login/check/phone/{phone}",
                "4105551212");
    ...
    void testResendOtp() throws Exception {
        ...
        MockHttpServletRequestBuilder contentTypeResult = MockMvcRequestBuilders.post("/login/otp/resend")
                .contentType(MediaType.APPLICATION_JSON);

        ObjectMapper objectMapper = new ObjectMapper();
        MockHttpServletRequestBuilder requestBuilder = contentTypeResult
                .content(objectMapper.writeValueAsString(new OtpModel(1L)));
        MockMvcBuilders.standaloneSetup(loginController)
                .build()
                .perform(requestBuilder)
                .andExpect(MockMvcResultMatchers.status().isOk())
    ...
    void testCheckUsernameExist() throws Exception {
        ...
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.post("/login/check/username/{username}",
                "janedoe");
        MockMvcBuilders.standaloneSetup(loginController)
                .build()
                .perform(requestBuilder)
    ...
    /**
     * Method under test: {@link LoginController#forgetPasswordOtpRequest(ForgetPasswordUpdateRequestModel)}
     */
    @Test
    void testForgetPasswordOtpRequest() throws Exception {
        when(loginService.createOtp((String) any())).thenReturn(new OtpModel(1L));
        MockHttpServletRequestBuilder contentTypeResult = MockMvcRequestBuilders.post("/login/forget")
                .contentType(MediaType.APPLICATION_JSON);

        ObjectMapper objectMapper = new ObjectMapper();
        MockHttpServletRequestBuilder requestBuilder = contentTypeResult
                .content(objectMapper.writeValueAsString(new ForgetPasswordUpdateRequestModel("janedoe")));
        MockMvcBuilders.standaloneSetup(loginController)
                .build()
                .perform(requestBuilder)
                .andExpect(MockMvcResultMatchers.status().isOk())
    ...
    void testForgetPasswordOtpRequest2() throws Exception {
        ...
        ObjectMapper objectMapper = new ObjectMapper();
        MockHttpServletRequestBuilder requestBuilder = contentTypeResult
                .content(objectMapper.writeValueAsString(new ForgetPasswordUpdateRequestModel("")));
        ResultActions actualPerformResult = MockMvcBuilders.standaloneSetup(loginController)
                .build()
                .perform(requestBuilder);
        actualPerformResult.andExpect(MockMvcResultMatchers.status().is(400));
    ...
    void testRegisterNewPassword() throws Exception {
        ...
        ObjectMapper objectMapper = new ObjectMapper();
        MockHttpServletRequestBuilder requestBuilder = contentTypeResult
                .content(objectMapper.writeValueAsString(new NewPasswordRequest("iloveyou")));
        ResultActions actualPerformResult = MockMvcBuilders.standaloneSetup(loginController)
                .build()
                .perform(requestBuilder);
    ...
    /**
     * Method under test: {@link LoginController#userChangePassword(UserChangePasswordRequestModel, Principal)}
     */
    @Test
    void testUserChangePassword() throws Exception {
        ...
        ObjectMapper objectMapper = new ObjectMapper();
        MockHttpServletRequestBuilder requestBuilder = contentTypeResult
                .content(objectMapper.writeValueAsString(new UserChangePasswordRequestModel("iloveyou", "2020-03-01")));
        ResultActions actualPerformResult = MockMvcBuilders.standaloneSetup(loginController)
                .build()
                .perform(requestBuilder);
        actualPerformResult.andExpect(MockMvcResultMatchers.status().is(415));
    ...
    void testValidateOtp() throws Exception {
        MockHttpServletRequestBuilder contentTypeResult = MockMvcRequestBuilders.put("/login/otp/validate")
                .header("x-otp-validate-forget", true)
                .contentType(MediaType.APPLICATION_JSON);

        ObjectMapper objectMapper = new ObjectMapper();
        MockHttpServletRequestBuilder requestBuilder = contentTypeResult
                .content(objectMapper.writeValueAsString(new OtpRequestModel(1L, 1)));
        ResultActions actualPerformResult = MockMvcBuilders.standaloneSetup(loginController)
                .build()
                .perform(requestBuilder);
        actualPerformResult.andExpect(MockMvcResultMatchers.status().is(400));
